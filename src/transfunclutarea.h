...
#ifndef TRANS_FUNC_LUTAREA_H
#define TRANS_FUNC_LUTAREA_H
...
class TransFuncLutArea : public TransFuncArea
{
    Q_OBJECT

public:
    TransFuncLutArea() {};
    TransFuncLutArea(PresetManager *prman);
    ~TransFuncLutArea();
...
private:
    ...
    QLinearGradient gradient; // do I need this?
};

#endif // TRANS_FUNC_LUTAREA_H
